...
bucket_name = "finley_testbucket5"
project_name = "dulcet-order-323902"
project = os.getenv('GOOGLE_CLOUD_PROJECT') or project_name 
...
create_instance(service,project_name,zone,instance_name_template, bucket_name)
set_tag(service, project_name, "us-west1-b", "demo-instance2")
